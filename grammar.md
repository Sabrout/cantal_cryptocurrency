...
```
CHEESE -> HASH SEPARATOR_CHEESE_ELEM LIST_TRANSACTION SEPARATOR_CHEESE_ELEM DIGIT.
```
...
TRANSACTION -> LIST_INPUT SEPARATOR LIST_WALLET SEPARATOR LIST_AMOUNT SEPARATOR LIST_SIGN.
