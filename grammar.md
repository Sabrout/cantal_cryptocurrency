...
LIST_WALLET_NEXT -> SEPARATOR_TRANSACTION_INNER PUBLIC_KEY LIST_WALLET_NEXT | . 
...
LIST_SIGN_NEXT -> SEPARATOR_TRANSACTION_INNER SIGNATURE LIST_SIGN_NEXT | .

USED_OUTPUT -> HASH SEPARATOR_TRANSACTION_INNER HASH.
```
